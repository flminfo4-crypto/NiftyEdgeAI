 ...
 * market-profile.html (TPO letters) and volume-profile.html (volume bars).
 ...
 * `sessions` is oldest-first, matching /market/profile/composite and
 * /market/volume-profile/composite.
 */
(function () {
  var HEADER_H = 20;
  var CHART_H = 520;
  ...
  function renderCompositeChart(canvas, sessions, opts) {
    ...
    var agg = {};
    var weightKey = mode === "tpo" ? "tpoCount" : "volume";
    ...
    sessions.forEach(function (s, i) {
      ...
      s.rows.forEach(function (r) {
        ...
        var inVa = r.price <= s.vah && r.price >= s.val;
        var isPoc = r.price === s.poc;
